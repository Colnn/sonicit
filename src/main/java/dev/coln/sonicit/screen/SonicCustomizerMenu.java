...
public class SonicCustomizerMenu extends AbstractContainerMenu {
    public final SonicCustomizerBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public SonicCustomizerMenu(int id, Inventory inventory, FriendlyByteBuf extraData) {
        this(id, inventory, inventory.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(4));
    }

    public SonicCustomizerMenu(int id, Inventory inventory, BlockEntity blockEntity, ContainerData data) {
        super(MenuTypeInit.SONIC_CUSTOMIZER_MENU.get(), id);
        checkContainerSize(inventory, 3);
        this.blockEntity = (SonicCustomizerBlockEntity) blockEntity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, BlockInit.SONIC_CUSTOMIZER.get());
    }
